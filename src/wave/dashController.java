...
public class dashController implements Initializable {
    ...
    final Paint PAINT_ACCENT = Paint.valueOf("#9EB2F8");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        volumeSlider.setValue(Double.parseDouble(config.get("volume")));
        volumeSlider.valueProperty().addListener((observable, oldVal, newVal) ->
        {
            ...
            updateConfig("volume", ""+newVal.floatValue());
            musicPanePlayPauseButton.requestFocus();
        });
        ...
        musicPanePlayPauseButton.setOnKeyPressed(event -> {
    ...
    private void loadPlaylist(String playlistName,boolean show)
    {
        ...
        for(HashMap<String,Object> eachSong : songs)
        {
            ...
            Platform.runLater(()->{
                ...
                downloadButton.setTextFill(PAINT_ACCENT);
                ...
                saveToPlaylistButton.setTextFill(PAINT_ACCENT);
    ...
    private void refreshPlaylistsUI()
    {
        ...
        addNewPlaylistVBox.setAlignment(Pos.CENTER);
            ...
            new Thread(new Task<Void>() {
                ...
                protected Void call(){
                    try
                    {
                        ...
                        JFXTextField pName = new JFXTextField();
                        pName.setFont(robotoRegular25);
                        pName.setStyle("-fx-text-fill: WHITE;");
                        JFXButton addButton = new JFXButton("ADD");
                        addButton.setFont(robotoRegular15);
                        addButton.setTextFill(PAINT_ACCENT);
            ...
            protected Void call() {
                ...
                try {
                    ...
                    if (youtubeListView.getItems().size() > 0 && !youtubeNextPageToken.equals("")) {
                        ...
                        loadMoreButton.setTextFill(PAINT_ACCENT);
    ...
    private void switchPane(int paneNo)
    {
        ...
        if(currentSelectedPane!=paneNo)
        {
            ...
            if(paneNo == 1)
            {
                browseButton.setTextFill(PAINT_ACCENT);
            ...
            else if(paneNo == 2)
            {
                ...
                libraryButton.setTextFill(PAINT_ACCENT);
                settingsButton.setTextFill(PAINT_WHITE);
                playlistButton.setTextFill(PAINT_WHITE);
                downloadsButton.setTextFill(PAINT_WHITE);
                libraryPane.toFront();
            ...
            else if(paneNo == 3)
            {
                browseButton.setTextFill(PAINT_WHITE);
                libraryButton.setTextFill(PAINT_WHITE);
                playlistButton.setTextFill(PAINT_ACCENT);
                settingsButton.setTextFill(PAINT_WHITE);
                downloadsButton.setTextFill(PAINT_WHITE);
            ...
            else if(paneNo == 4)
            {
                ...
                playlistButton.setTextFill(PAINT_WHITE);
                settingsButton.setTextFill(PAINT_WHITE);
                downloadsButton.setTextFill(PAINT_ACCENT);
            ...
            else if(paneNo == 5)
            {
                ...
                libraryButton.setTextFill(PAINT_WHITE);
                playlistButton.setTextFill(PAINT_WHITE);
                settingsButton.setTextFill(PAINT_ACCENT);
                downloadsButton.setTextFill(PAINT_WHITE);
    ...
    public void updateConfig(String key, String newValue)
    {
        ...
        io.writeToFile(config.get("music_lib_path")+"::"+config.get("youtube_api_key")+"::"+config.get("max_recents_limit")+"::"+config.get("volume")+"::","config");
    }
